...
Table~\ref{tabstorymap} applies the same product release, sprint assignment and MoSCoW priority used in the backlog tables. The complete team map remains in Figure~\ref{figfullstorymap} in Appendix~\ref{appusecasemapping}.
...
Figure~\ref{figfullstorymap} preserves the complete team map with its personas, activities, backbone tasks and release priorities. Table~\ref{tabstorymap} and the mapping below use the same delivery fields.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{user-story-map.png}
