...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{@{}L{1.9cm}L{1.3cm}Y Y Y@{}}
        ...
        \midrule
        AC-US09-01 & Success & two users are connected on the platform & they open a conversation & they can send and receive messages through a secure in-app system without either party's personal contact details being visible\\
        ...
        AC-US09-04 & Error & a user attempts to include personal contact details in a message & the system detects this & it warns the user and recommends using the opt-in contact sharing feature instead\\
        ...
        AC-US09-06 & Edge case & a user's account is flagged as unverified & they attempt to initiate a conversation & the system displays a warning to the recipient that the sender is unverified before they choose to respond\\
        \bottomrule
    \end{tabularx}
    \label{tabacus09}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{@{}L{1.9cm}L{1.3cm}Y Y Y@{}}
        ...
        AC-US11-05 & Error & a user attempts to access the platform's core matching features without completing verification & they try to proceed & the system prompts them to complete verification first\\
