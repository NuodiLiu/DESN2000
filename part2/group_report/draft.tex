...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{@{}L{0.8cm}L{1.8cm}L{2.2cm}Y Y L{1.4cm}@{}}
        ...
        \midrule
        T1 & US-12 & Student new to shared housing & Complete the lifestyle profile. Try one incomplete submission and one contradictory selection. & At least 4 of 5 users finish within 3 minutes without help. The prototype identifies both invalid states. & Pranav Shanker\\
