...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{@{}L{0.8cm}L{1.8cm}L{2.2cm}Y Y L{1.4cm}@{}}
        ...
        T4 & US-09 & International student making first contact & Contact a listing with a guided prompt. Attempt to enter personal contact details. & At least 4 of 5 users send a message within 2 minutes. A warning appears before contact details are shared. The unverified notice is understood. & Dylan\\
