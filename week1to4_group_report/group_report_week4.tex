...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{@{}L{3.0cm} Y Y Y@{}}
        ...
        Existing housemate & Cleanliness, privacy, bills, shared rules and respect for household routines. & The housemate chooses a new person for an existing share house and wants to avoid future conflict. & It is difficult to discuss expectations clearly before the person moves in.\\
